...
**Language / Bahasa:** [English](README_EN.md) | **Indonesia** ([README.md](README.md))
...
📖 More detail: [INSTALLATION.md](INSTALLATION.md) (step-by-step guide) and [DATABASE_INSTALLATION_GUIDE.md](DATABASE_INSTALLATION_GUIDE.md) (technical troubleshooting & FAQ).
